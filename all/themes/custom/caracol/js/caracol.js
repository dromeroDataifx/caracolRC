(function($) {
    ...
    Drupal.behaviors.imagesdowload = {
        attach: function(context) {
             var triggers_dowloads = $('.view-agencia-de-noticias-nodos .views-field-field-imagen, .page-taxonomy .field-name-field-imagen');
            ...
            $(".view-agencia-de-noticias-nodos .views-field-php, .field-name-descaragar-img-personaje").die();
            $(".view-agencia-de-noticias-nodos .views-field-php, .field-name-descaragar-img-personaje").live({
...
//            defaultRow.addClass('expanded');
    ...
    Drupal.behaviors.selectedChange = {
        attach: function(context) {           
            var br = $('#all_productions_select');

            br.change(function(event){
                event.preventDefault();
                var tid = $(this).val();
                window.location = "/prensa/banco-de-recursos/"+ tid ; 
            }); 
        }
    },
    ...
    Drupal.behaviors.botonesProgramacion = {
      ...
      Drupal.behaviors.popupLogin = {
        attach: function(context) {     
            ...
            $(".not-logged-in.page-prensa .grid-8").addClass("popuplogin");
            $(".not-logged-in.page-prensa #sombralogin").addClass("sombra");
          
            $(".cerrar").click(function(event) {
                    event.preventDefault();
                $(".not-logged-in.page-prensa .grid-8").removeClass("popuplogin");
                $(".not-logged-in.page-prensa #sombralogin").removeClass("sombra");
